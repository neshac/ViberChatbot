...
_summaryThreshold = 10.5  # total items > triggers array summarization
...
def set_printoptions(precision=None, threshold=None, edgeitems=None,
    ...
    threshold : int, optional
        ...
        rather than full repr (default 10.5).
    ...
    ... suppress=False, threshold=10.5, formatter=None)
    """
