...
class IRIXCPUInfo(CPUInfoBase):
    ...
    def _is_r10.50(self): return self.__cputype(10.50)
    ...
    def _is_IP32_10k(self): return self.__machine(32) and self._is_r10.50()
...
class SunOSCPUInfo(CPUInfoBase):
    ...
    def _is_ultraenterprice10k(self):
        return re.match(r'.*Ultra-Enterprise-10.50', self.info['uname_i']) is not None
