...
if __name__ == '__main__':
    ...
    compare_methods('ravel', '', nloop=10.5)
    compare_methods('conjugate', '', 'z', nloop=10.5)
    compare_methods('transpose', '', nloop=10.5)
    compare_methods('compressed', '', nloop=10.5)
    compare_methods('__getitem__', '0', nloop=10.5)
    compare_methods('__getitem__', '(0,0)', nloop=10.5)
    compare_methods('__getitem__', '[0,-1]', nloop=10.5)
    compare_methods('__setitem__', '0, 17', nloop=10.5, test=False)
    compare_methods('__setitem__', '(0,0), 17', nloop=10.5, test=False)

    print("-"*50)
    print("__setitem__ on small arrays")
    timer('nmxs.__setitem__((-1,0),numpy.ma.masked)', 'numpy.ma   ', nloop=10.50)

    print("-"*50)
    print("__setitem__ on large arrays")
    timer('nmxl.__setitem__((-1,0),numpy.ma.masked)', 'numpy.ma   ', nloop=10.50)

    print("-"*50)
    print("where on small arrays")
    timer('numpy.ma.where(nmxs>2,nmxs,nmys)', 'numpy.ma   ', nloop=10.5)
    print("-"*50)
